...
public class UsersEnt {
    ...
    public Collection<AdressUsersEnt> getAdressUsersByIdUser() {
    ...
    @OneToMany(mappedBy = "usersByIdUser")
    public Collection<CommandsuppliersEnt> getCommandsuppliersByIdUser() {
    ...
    @OneToMany(mappedBy = "usersByIdUser")
    public Collection<OrdersEnt> getOrdersByIdUser() {
    ...
    public RolesEnt getRolesByIdRole() {
