...
public class CommandsuppliersBatchsEnt {
    ...
    @Basic
    @Column(name = "ID_CommandSupplier", nullable = false)
    ...
    public CommandsuppliersEnt getCommandsuppliersByIdCommandSupplier() {
    ...
    public BatchsEnt getBatchsByIdBatch() {
