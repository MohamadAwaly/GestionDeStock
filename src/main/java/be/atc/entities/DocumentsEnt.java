...
public class DocumentsEnt {
    ...
    @ManyToOne
    @JoinColumn(name = "ID_DocumentType", referencedColumnName = "ID_TypeDocument", nullable = false)
    public DocumenttypesEnt getDocumenttypesByIdDocumentType() {
    ...
    public Collection<OrdersDocumentsEnt> getOrdersDocumentsByIdDocument() {
        return ordersDocumentsByIdDocument;
    }

    public void setOrdersDocumentsByIdDocument(Collection<OrdersDocumentsEnt> ordersDocumentsByIdDocument) {
