...
public class CommandsuppliersEnt {
    ...
    public SuppliersEnt getSuppliersByIdSupplier() {
    ...
    @OneToMany(mappedBy = "commandsuppliersByIdCommandSupplier")
    public Collection<CommandsuppliersBatchsEnt> getCommandsuppliersBatchsByIdCommandSuppliers() {
        return commandsuppliersBatchsByIdCommandSuppliers;
    }

    public void setCommandsuppliersBatchsByIdCommandSuppliers(Collection<CommandsuppliersBatchsEnt> commandsuppliersBatchsByIdCommandSuppliers) {
