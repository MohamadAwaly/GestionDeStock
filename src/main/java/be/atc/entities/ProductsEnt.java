...
public class ProductsEnt {
    ...
    public boolean equals(Object o) {
        ...
        return idProduct == that.idProduct && idBrand == that.idBrand && quantityTotal == that.quantityTotal && unitCostPrice == that.unitCostPrice && margin == that.margin && length == that.length && width == that.width && height == that.height && Objects.equals(code, that.code) && Objects.equals(designation, that.designation);
    }

    @Override
    public int hashCode() {
        return Objects.hash(idProduct, idBrand, code, designation, quantityTotal, unitCostPrice, margin, length, width, height);
    }

    @OneToMany(mappedBy = "productsByIdProducts")
    public Collection<BatchsEnt> getBatchsByIdProduct() {
    ...
    public Collection<OrdersProductsEnt> getOrdersProductsByIdProduct() {
    ...
    public BrandsEnt getBrandsByIdBrand() {
    ...
    @OneToMany(mappedBy = "productsByIdProduct")
    public Collection<ProductsCategoriesEnt> getProductsCategoriesByIdProduct() {
        return productsCategoriesByIdProduct;
    }

    public void setProductsCategoriesByIdProduct(Collection<ProductsCategoriesEnt> productsCategoriesByIdProduct) {
